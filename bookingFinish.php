...
?>
    ...
    <div class="container padding20 grid" style="background-color: #FFFFFF;">
		<legend>Hayu Ulin dan Travel <i class="place-right"><small>Tanggal : <?php $tgl= date("d M Y"); echo $tgl;?></small></i></legend>
		<div class="row">
            <div class="span4">
				<p class="tertiary-text-secondary"><strong>Hayu Ulin Tour and Travel </strong><br />
				Jalan A.H Nasution No. 105<br />
				Cipadung,Cibiru<br />
				Kota Bandung ,Jawa Barat 40614</p>
				<p class="tertiary-text-secondary">hayuulintourtravel@gmail.com<br />
				089683834288</p>
				<p class="tertiary-text-secondary">BCA : 3120618040 a/n Aditya Nugraha Adha<br />
				Mandiri : 1110005416478 a/n Muhamad Fauzi Rachman</p>
            </div>
			<div class="span3">
