                            ...
                            ?>
                                <fieldset>
                                    ...
                                    <div class="form-group">
                            			...
                            			<input class="form-control" name="nama_paket" type="text" placeholder="Input nama paket" value="<?php if(isset($_GET['id'])){ echo $ngisi['nama_paket'];} ?>">
                            		</div>
                                    	<label>Nama Paket</label>
                                    <div class="form-group input-group">
                                        <span class="input-group-addon">Rp</span>
                            			<input class="form-control" name="harga_paket" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['harga_paket'];} ?>">
                                        <span class="input-group-addon">,00</span>
                            		</div>
                                	<div class="form-group">
                                    	<label>Description</label>
                            			<textarea class="form-control" name="ket_paket"><?php if(isset($_GET['id'])){ echo $ngisi['ket_paket'];} ?></textarea>
                            		</div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>
								...
								?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupPaket.php?id=<?php if(isset($_GET['id'])){ echo $isi_tbl[0];} ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Paket"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
