                    ...
                    <div class="panel-body">
                        ...
                        ?>
                            <fieldset>
                                <div class="row">
                                <div class="col-lg-4">
                                <input name="id" type="hidden" value="<?php if(isset($_GET['id'])){ echo $ngisi[0];} ?>">
                                <div class="form-group">
                                    <label>Email</label>
                            		<input class="form-control" name="email" type="text" placeholder="Input email" value="<?php if(isset($_GET['id'])){ echo $ngisi[5];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>Kota</label>
                                    <input class="form-control" name="kota" type="text" placeholder="Input Kota" value="<?php if(isset($_GET['id'])){ echo $ngisi[2];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                    <textarea class="form-control" name="alamat" rows="2"><?php if(isset($_GET['id'])){ echo $ngisi[1];} ?></textarea>
                                </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="no_hp" type="text" placeholder="Input nomor handphone" value="<?php if(isset($_GET['id'])){ echo $ngisi[3];} ?>">
                                </div>
                                    <label>Telepon</label>
                            		<input class="form-control" name="no_tlp" type="text" placeholder="Input nomor telepon" value="<?php if(isset($_GET['id'])){ echo $ngisi[4];} ?>">
                                </div>
                                <div class="form-group">
                                    <label>More Description</label>
									<textarea name="content"><?php if(isset($_GET['id'])){ echo $ngisi[6];} ?></textarea>
                                </div>
                                </div>
                                </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupContact.php?id=<?php if(isset($_GET['id'])){ echo $isi_tbl[0];} ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Contact"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
