...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_GET['judul'])){ $judul=ucwords(strtolower($_POST['judul']));}
...
<head>
    ...
    <title>Setup Seni dan Budaya Bandung</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Seni dan Budaya Bandung</h3></div>
                                ...
                                <fieldset>
                                	...
                                	<div class="form-group">
                                        ...
                                        <input class="form-control" name="judul" type="text" placeholder="Input nama paket" 
                            				value="<?php if(isset($_GET['id'])){ echo $ngisi[2];} ?>">
                                    </div>
                                	<div class="form-group">
                                    	<label>Isi/Content</label>
                                        <textarea class="form-control" name="konten"><?php if(isset($_GET['id'])){ echo $ngisi[3];} ?></textarea>
                                    </div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>									
