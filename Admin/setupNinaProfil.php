...
if(isset($_SESSION['user_admin'])){
    ...
    if (isset($_POST['judul'])) {$judul=ucwords(strtolower($_POST['judul']));}
...
<head>
    ...
    <title>Setup Hayu ulin Tour</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Hayu ulin Tour</h3></div>
							...
							?>
                                <fieldset>
                                	...
                                	<div class="form-group">
                                        ...
                                        <textarea class="form-control" name="konten"><?php if(isset($_GET['id'])){ echo $ngisi[3];} 
                                            ?></textarea>
                                    </div>
                                    <?php
                                        if (isset($_GET['id'])){
