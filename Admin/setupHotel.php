                            ...
                            ?>
                                ...
                                <div class="col-lg-4">
                                	...
                                	<div class="form-group">
                            			...
                            			<input class="form-control" name="hotel" type="text" placeholder="ex: Nama Penginapan (Kelas Kamar) 1H" value="<?php if(isset($_GET['id'])){ echo $ngisi[2];} ?>">
                                	</div>
								</div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group input-group">
                            			...
                            			<input class="form-control" name="harga" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi[4];} ?>">
                                ...
                                <div class="col-lg-8">
                                    <div class="form-group">
                            			...
                            			<textarea class="form-control" name="ket_hotel"><?php if(isset($_GET['id'])){ echo $ngisi[5];} ?></textarea>
                                  	</div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupHotel.php?id=<?php if(isset($_GET['id'])){ echo $isi_tbl[0];} ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Penginapan"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
