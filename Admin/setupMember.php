                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" size="1" name="id" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['id_user'];} ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Username</label>
                                    <input class="form-control" name="username" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['username'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="form-control" name="password" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['password'];} ?>" >
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Nama Member</label>
                                    <input class="form-control" name="nama_user" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['nama_user'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input class="form-control" name="email" type="email" value="<?php if(isset($_GET['id'])){ echo $ngisi['email_user'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Handphone</label>
                                    <input class="form-control" name="no_hp" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['no_hp'];} ?>" >
                                </div>
                       		</div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Jenis Kelamin</label>
                                    <input class="form-control" name="jekel" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['jekel'];} ?>" >
                                </div>
                                <div class="form-group">
                                  <label>Alamat Member</label>
                                    <textarea name="alamat" rows="1" class="form-control" ><?php if(isset($_GET['id'])){ echo $ngisi['alamat'];} ?></textarea>
                                </div>
                       		</div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input class="form-control" name="tgl_lahir" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['tgl_lahir'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>No. Rekening</label>
                                    <input class="form-control" name="no_rek" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['no_rek'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Rekening atas Nama</label>
                                    <input class="form-control" name="nama_rek" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['nama_rek'];} ?>" >
                                </div>
                       		</div>
                            </div>
                                <?php
