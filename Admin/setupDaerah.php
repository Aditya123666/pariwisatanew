                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-6">
                            ...
                            ?>
                                <fieldset>
									<input name="id" type="hidden" value="<?php if(isset($_GET['id'])){ echo $ngisi['id_daerah'];} ?>">
                                	<div class="form-group">
                                    	<label>Kode Daerah</label>
                            			<input class="form-control" name="kode" type="text" placeholder="Input kode daerah" value="<?php if(isset($_GET['id'])){ echo $ngisi['kode'];} ?>">
                                    </div>
                                	<div class="form-group">
                                    	<label>Nama Daerah</label>
                            			<input class="form-control" name="daerah" type="text" placeholder="Input nama daerah" value="<?php if(isset($_GET['id'])){ echo $ngisi['daerah'];} ?>">
                                    </div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>
