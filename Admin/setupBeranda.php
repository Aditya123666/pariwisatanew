...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_POST['Tambah'])){
		...
		mysqli_query($kon,"INSERT INTO setup_dasboard (nama, konten, gambar) value ('$judul', '$_POST[konten]', '')") or die(mysqli_error());
                                ...
                                <fieldset>
                                	...
                                	<div class="form-group">
                                        ...
                                        <input class="form-control" name="nama" type="text" placeholder="Input judul posting" 
                                        	value="<?php if (isset($_GET['id'])){echo $ngisi[1];} ?>" required>
                                    </div>
                                	<div class="form-group">
                                    	<label>Isi/Content</label>
                                        <textarea class="form-control" name="konten"><?php if (isset($_GET['id'])){echo $ngisi[2];} ?></textarea>
                                    </div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>
