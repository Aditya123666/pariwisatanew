                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="id" type="text" value="<?php if (isset($_GET['id'])){echo $ngisi['id_pesan'];}  ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="tgl_tour" type="text" value="<?php if (isset($_GET['id'])){echo $ngisi['tgl_tour'];} ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Pesan</label>
                                    <input class="form-control" name="tgl_tour" type="text" value="<?php if (isset($_GET['id'])){echo $ngisi['tgl_pesan'];} ?>" readonly>
                                </div>
                       		</div>
                            </div>
                                <?php
