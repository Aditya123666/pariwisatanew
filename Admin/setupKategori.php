...
if(isset($_SESSION['user_admin'])){
	...
	if(isset($_GET['judul'])){ $kat=ucwords(strtolower($_POST['kategori']));}
                            ...
                            ?>
                                <fieldset>
                                	...
                                	<div class="form-group">
                            			...
                            			<input class="form-control" name="kategori" type="text" placeholder="Input nama kategori" value="<?php if(isset($_GET['id'])){ echo $ngisi[1];} ?>">
									</div>
                                	<div class="form-group">
                                    	<label>Description</label>
                            			<textarea class="form-control" name="keterangan"><?php if(isset($_GET['id'])){ echo $ngisi[2];} ?></textarea>
                            		</div>
                                    <?php
                                        if (isset($_GET['id'])){
                                    ?>
