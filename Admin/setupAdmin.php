...
if(isset($_SESSION['user_admin'])){
	...
	{
		if(isset($_GET['nama'])){ $nama=ucwords(strtolower($_POST['nama']));}
		mysqli_query($kon,"INSERT INTO tbl_admin (user_admin, pass_admin, level, aktif, nama)
				value ('$_POST[user]','$_POST[pass]','$_POST[level]','$_POST[status]','$nama')") or die(mysqli_error());
	}
                        ...
                        <fieldset>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="user" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['user_admin'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input class="form-control" name="pass" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['pass_admin'];} ?>" >
                                </div>
                                <div class="form-group">
                                    <label>Nama Lengkap</label>
                                    <input class="form-control" name="nama" type="text" value="<?php if(isset($_GET['id'])){ echo $ngisi['nama'];} ?>" >
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
